...
<section class="section-header pb-0 pb-lg-0 bg-dark text-white">
    <div class="container">
            ...
            <div class="glide">
                <div class="glide__track" data-glide-el="track">
                    <ul class="glide__slides">
                        <li style="background-image: url('https://lumiere-a.akamaihd.net/v1/images/p_shangchi_disneyplus_21155_c1b60b55.jpeg'); background-size: fit; height:500px"  class="glide__slide">
                            <!-- <div></div> -->
                        </li>
                        <li style="background-image: url('https://lumiere-a.akamaihd.net/v1/images/p_shangchi_disneyplus_21155_c1b60b55.jpeg'); background-size: fit; height:500px"  class="glide__slide">
                            <!-- <div></div> -->
...
<section class="section section-ld">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <h2 class="mb-4 mb-lg-5 text-sm">New Movies</h2>
            </div>
