...
.one {
	background: url('https://hips.hearstapps.com/hmg-prod.s3.amazonaws.com/images/best-movies-for-kids-2020-disney-artemis-fowl-1571177691.jpg');
...
.two {
	background: url('https://i.pinimg.com/originals/0b/63/12/0b63128f7d72c291ab002d91239d562f.png');
	background-repeat: no-repeat;
	background-size: cover;
	background-position: center;
}
...
.five {
	background: url('https://im.rediff.com/movies/2021/jan/07vijay-the-master.jpg');
	background-repeat: no-repeat;
	background-size: cover;
	background-position: center;
}
.six {
	background: url('https://i.pinimg.com/736x/09/7f/b3/097fb3ccbd9489bd49874062b7c5bb72.jpg');
	background-repeat: no-repeat;
	background-size: cover;
	background-position: center;
}
.seven {
	background: url('https://hips.hearstapps.com/hmg-prod.s3.amazonaws.com/images/hotel-transylvania-3-1543254091.jpg?crop=0.846xw:1.00xh;0.0739xw,0&resize=480:*');
	background-repeat: no-repeat;
	background-size: cover;
	background-position: center;
}
.eight {
	background: url('https://www.africanvibes.com/wp-content/uploads/2021/01/living-in-bondage-breaking-free.jpg');
	background-repeat: no-repeat;
	background-size: cover;
	background-position: center;
}
.nine {
	background: url('https://filmfare.wwmindia.com/content/2021/jan/bollywood-upcoming-movies-gangubai-kathiawadi-51611325299.jpg');
	background-repeat: no-repeat;
	background-size: cover;
	background-position: center;
}
...
<body>
    ...
    <script src="/dist/glide.esm.js"></script>
    <script>
